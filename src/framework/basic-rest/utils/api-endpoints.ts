export const API_ENDPOINTS = {
  ...
  TOP_SELL_PRODUCTS: "/products?orderby=popularity",
  FLASH_SELL_PRODUCTS: "/products?orderby=popularity",
  FEATURED_PRODUCTS: "products?featured=true",
  SELLING_PRODUCTS: "products?on_sale=true",
  NEW_ARRIVAL_PRODUCTS: "products?orderby=date",
